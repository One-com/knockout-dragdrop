            ...
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                function beginEvent(downEvent) {
                    ...
                    function startDragging(startEvent) {
                        ...
                        document.removeEventListener('touchmove', onMouseMoveStartDrag, true);
                        ...
                        function finishEvent(upEvent) {
                            ...
                            cloneEvent.target = document.elementFromPoint(
                                getEventCoord(upEvent, 'pageX'),
                                getEventCoord(upEvent, 'pageY')
                            );
                    ...
                    document.addEventListener('touchmove', onMouseMoveStartDrag, true);
